(function(module) {
     ...
     * @class WindowManager
     */
    var WindowManager = module.exports = function() {
        this._windows = [];
    ...
    WindowManager.prototype.buildWindowOfType = function(type) {
        var window = (this._buildProcedures[type])();
    ...
    WindowManager.prototype.deregister = function(window) {
        for (var i = 0, windowsLen = this._windows.length; i < windowsLen; i += 1) {
    ...
    WindowManager.prototype.getCountOfType = function(type) {
        return this._windows.reduce(function(count, currentObj) {
    ...
    WindowManager.prototype.getWindowsOfType = function(type) {
        return this._windows.reduce(function(windows, currentObj) {
